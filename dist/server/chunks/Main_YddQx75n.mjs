import { c as createComponent, m as maybeRenderHead, s as spreadAttributes, e as addAttribute, n as renderSlot, a as renderTemplate, d as createAstro, r as renderComponent, b as renderScript } from './astro/server_zxv3i2-L.mjs';
import 'piccolore';
import 'clsx';
import { $ as $$Layout } from './Layout_BC3CbwLl.mjs';
/* empty css                         */
...
const $$ProxyStatus = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div id="proxy-status"${addAttribute(`inline-flex items-center ${className}`, "class")} title="Proxy engine status" role="status" aria-live="polite" aria-atomic="true" aria-label="Proxy engine status"> <span id="proxy-status-dot" class="h-2 w-2 rounded-full bg-text-muted animate-pulse"></span> </div> ${renderScript($$result, "/Users/arman/Documents/GitHub/armsn/src/components/ProxyStatus.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/arman/Documents/GitHub/armsn/src/components/ProxyStatus.astro", void 0);
...
const $$Main = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const adminLink = { href: "/admin", text: "Admin"};
