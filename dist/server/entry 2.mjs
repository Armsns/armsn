...
import { manifest } from './manifest_Ch8byW9r.mjs';
...
const _page5 = () => import('./pages/e/_---slug_.astro.mjs');
const _page6 = () => import('./pages/games.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/chat.astro", _page4],
    ["src/pages/e/[...slug].ts", _page5],
    ["src/pages/games.astro", _page6],
