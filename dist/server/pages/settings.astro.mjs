import { c as createComponent, r as renderComponent, m as maybeRenderHead, b as renderTemplate, d as createAstro, e as addAttribute, n as renderSlot, a as renderScript } from '../chunks/astro/server_qhutUUez.mjs';
import 'piccolore';
import { a as $$, $ as $$Main, b as $$LayoutGrid } from '../chunks/Main_BE-5h5_F.mjs';
...
}, "/Users/arman/Desktop/Arm$n/node_modules/lucide-astro/dist/ExternalLink.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/node_modules/lucide-astro/dist/EyeOff.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/node_modules/lucide-astro/dist/Globe.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/node_modules/lucide-astro/dist/Siren.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/node_modules/lucide-astro/dist/SwatchBook.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/node_modules/lucide-astro/dist/Users.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/src/components/ArrowButton.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/src/components/Dropdown.astro", void 0);
...
}, "/Users/arman/Desktop/Arm$n/src/components/SettingsCard.astro", void 0);
...
const $$Settings = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ] })} ` })} <div id="admin-panel" class="hidden"> ${renderComponent($$result2, "SettingsCard", $$SettingsCard, { "description": "Create and manage user accounts", "title": "User Management", "Icon": $$Users }, { "default": async ($$result3) => renderTemplate` <form id="add-user-form" class="space-y-2"> <input id="new-username" placeholder="Username" required class="w-full h-9 px-3 bg-white/5 border border-white/10 rounded text-sm text-text placeholder:text-text-placeholder focus:outline-none focus:border-white/25 transition-all"> <input id="new-password" type="password" autocomplete="new-password" placeholder="Password" required minlength="6" class="w-full h-9 px-3 bg-white/5 border border-white/10 rounded text-sm text-text placeholder:text-text-placeholder focus:outline-none focus:border-white/25 transition-all"> <p class="text-xs text-text-secondary">Password must be at least 6 characters.</p> <button type="submit" class="w-full h-9 mt-2 rounded bg-accent/20 text-accent font-semibold hover:bg-accent/30 transition-colors text-sm">
add
</button> </form> <div class="mt-4"> <p class="text-xs text-text-secondary mb-2 uppercase font-semibold tracking-wider">Users</p> <ul id="user-list" class="space-y-2 text-sm text-text"> <li class="text-text-secondary">Loading...</li> </ul> </div> ` })} </div> </div> </div> ${renderScript($$result2, "/Users/arman/Desktop/Arm$n/src/pages/settings.astro?astro&type=script&index=0&lang.ts")} ${renderScript($$result2, "/Users/arman/Desktop/Arm$n/src/pages/settings.astro?astro&type=script&index=1&lang.ts")} ` })}`;
}, "/Users/arman/Desktop/Arm$n/src/pages/settings.astro", void 0);

const $$file = "/Users/arman/Desktop/Arm$n/src/pages/settings.astro";
const $$url = "/settings";
