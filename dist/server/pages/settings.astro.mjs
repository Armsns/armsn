...
import 'piccolore';
import { b as $$, $ as $$Main, a as $$Search, c as $$LayoutGrid } from '../chunks/Main_BbO4iuhH.mjs';
import 'clsx';
...
const $$Settings = createComponent(($$result, $$props, $$slots) => {
  ...
  ] })} ` })} </div> </div> ${renderScript($$result2, "/Users/arman/Desktop/Arm$n/src/pages/settings.astro?astro&type=script&index=0&lang.ts")} ` })}`;
