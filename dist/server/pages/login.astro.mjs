...
Sign in
</button> </form> </div> </div> ` })} ${renderScript($$result, "/Users/arman/Desktop/Arm$n/src/pages/login.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/arman/Desktop/Arm$n/src/pages/login.astro", void 0);

const $$file = "/Users/arman/Desktop/Arm$n/src/pages/login.astro";
const $$url = "/login";
