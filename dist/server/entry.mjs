...
import { manifest } from './manifest_DT1HTtpW.mjs';
...
const _page4 = () => import('./pages/scramjet/_---slug_.astro.mjs');
const _page5 = () => import('./pages/settings.astro.mjs');
const _page6 = () => import('./pages/tabs.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/scramjet/[...slug].ts", _page4],
    ["src/pages/settings.astro", _page5],
    ["src/pages/tabs.astro", _page6],
...
const _args = {
    "mode": "middleware",
    "client": "file:///Users/arman/Desktop/Arm$n/dist/client/",
    "server": "file:///Users/arman/Desktop/Arm$n/dist/server/",
    "host": false,
    "port": 4321,
    "assets": "_astro",
