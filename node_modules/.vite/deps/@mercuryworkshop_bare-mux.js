...
var k = class {
  ...
  async fetch(e2, r2) {
    const a2 = new Request(e2, r2), s2 = (r2 == null ? void 0 : r2.headers) || a2.headers, o2 = s2 instanceof Headers ? Object.fromEntries(s2) : s2, n2 = a2.body;
    ...
    for (let e3 = 0; ; e3++) {
      ...
      const i2 = (r2 == null ? void 0 : r2.redirect) || a2.redirect;
...
//# sourceMappingURL=@mercuryworkshop_bare-mux.js.map
