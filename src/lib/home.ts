...
const initHome = () => {
  ...
  if (tagline) {
    const messages = ["every dollar finds its way.", "deposit your URL. collect your content.", "interest rates this fast.", "silent as a vault.", "fully audited. fully yours.", "the green light for anything.", "ARM up. log in.", "no taxes on cargo.", "money moves at the speed of light.", "balance: untraceable."];
